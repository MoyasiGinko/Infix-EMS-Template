    ...
    public function calenderData()
    {
        // CalenderQuery Start
            ...
            foreach ($leaveDatas as $leaveData) {
                $eventData[] = [
                    'title' => __('communicate.leave').'- '.$leaveData->user->full_name ?? '',
                    'name' => $leaveData->user->full_name ?? '',
            ...
            foreach ($libraryDatas as $libraryData) {
                $eventData[] = [
                    'title' => __('communicate.library').'- '.$libraryData->user->full_name ?? '',
                    'book_name' => $libraryData->books->book_title ?? '',
