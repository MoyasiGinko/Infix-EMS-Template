    ...
    <div class="student_info">
      <div class="single_student_information d-flex align-items-center">
        ...
        <div class="student_grid_box d-flex align-items-center flex-fill">
          ...
          <span>:</span>
          <span
            class="f_w_500 theme_text text-uppercase">{{@$admitcard->studentRecord->studentDetail->admission_no}}</span>
        </div>
        @endif
      </div>
      ...
      <div class="single_student_information d-flex align-items-center">
        ...
        <div class="student_grid_box d-flex align-items-center flex-fill">
          ...
          <span>:</span>
          <span
            class="f_w_500 theme_text text-uppercase">{{@$admitcard->studentRecord->studentDetail->full_name}}</span>
        </div>
        @endif
        ...
        <p class="m-0">
          ...
          @if(shiftEnable())
          {{isset($admitcard->studentRecord->shift) ? ' ['. $admitcard->studentRecord->shift->name.']' : ''}} @endif
          @endif
      ...
      <div class="single_student_information d-flex align-items-center">
        <div class="student_grid_box d-flex align-items-center flex-fill">
          ...
          <span>:</span>
          <span
            class="f_w_400  text-uppercase">{{@$admitcard->studentRecord->studentDetail->parents->fathers_name}}</span>
        </div>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $exam_routine->subject ? $exam_routine->subject->subject_name :'' }} </strong>
            {{ $exam_routine->subject ? '('.$exam_routine->subject->subject_code .')':'' }}</td>
