            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a class="text-color" data-toggle="modal" data-target="#showNote{{ $walletAmount->id }}"
                    href="#">@lang('common.view')</a>
                  @endif
                </td>
                <td>
                  @if (file_exists($walletAmount->file))
                  <a class="text-color" data-toggle="modal" data-target="#showFile{{ $walletAmount->id }}"
                    href="#">@lang('common.view')</a>
                  @endif
                </td>
                <td>
                ...
                <td>
                  ...
                  <a class="text-color" data-toggle="modal" data-target="#feedBack{{ $walletAmount->id }}"
                    href="#">@lang('common.view')</a>
                  @endif
                </td>
              </tr>
                      ...
                      <div class="container student-certificate">
                        <div class="row justify-content-center">
                          <div class="col-lg-12 text-center">
                            ...
                            @if (@$for_pdf == 'pdf')
                            <div class="mb-5">
                              <a href="{{ url(@$walletAmount->file) }}" download>@lang('common.download') <span
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="primary_input">
                  <label class="primary_input_label" for="">@lang('wallet::wallet.amount') <span class="text-danger">
                      *</span> </label>
            ...
            <div class="row mt-20">
              <div class="col-lg-12">
                <label class="primary_input_label" for="">@lang('fees.payment_method') <span class="text-danger">
                    *</span> </label>
                <select class="primary_select  form-control" name="payment_method" id="addWalletPaymentMethod">
            ...
            <div class="row mt-20 AddWalletChequeBank d-none">
              <div class="col-lg-12">
                <div class="primary_input">
                  ...
                  <textarea class="primary_input_field form-control" cols="0" rows="3" name="note"
            ...
            <div class="stripeInfo d-none">
              <div class="row mt-30">
                <div class="col-lg-12">
                  <div class="primary_input">
                    <label class="primary_input_label" for="">@lang('accounts.name_on_card') <span class="text-danger">
                        *</span> </label>
                    <input
              ...
              <div class="row mt-30">
                <div class="col-lg-12">
                  <div class="primary_input">
                    <label class="primary_input_label" for="">@lang('accounts.card_number') <span class="text-danger">
                        *</span> </label>
                    <input class="primary_input_field form-control card-number" type="text" name="card-number"
                      id="card-number" autocomplete="off" value="{{ old('card-number') }}">
              ...
              <div class="row mt-30">
                <div class="col-lg-12">
                  <div class="primary_input">
                    <label class="primary_input_label" for="">@lang('accounts.cvc') <span class="text-danger"> *</span>
                    </label>
                    <input class="primary_input_field form-control card-cvc" type="text" name="card-cvc" id="card-cvc"
                ...
                <div class="col-lg-12">
                  <div class="primary_input">
                    <label class="primary_input_label" for="">@lang('accounts.expiration_year') <span
                        class="text-danger"> *</span> </label>
                    <input class="primary_input_field form-control card-expiry-year" type="text" name="card-expiry-year"
                      id="card-expiry-year" autocomplete="off" value="{{ old('card-expiry-year') }}">
...
(function() {
  ...
  if (refundAmt && !refundAmt.readOnly) {
    refundAmt.addEventListener('input', function() {
      this.value = enforceNumeric(this.value);
    });
    refundAmt.addEventListener('blur', function() {
      finalize(this);
    });
  }
})();
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row mt-20">
              <div class="col-lg-12">
                <div class="primary_input">
                  <label class="primary_input_label" for="">@lang('wallet::wallet.note')<span class="text-danger">
                      *</span></label>
            ...
            <div class="row no-gutters input-right-icon mt-25">
              <div class="col">
                <div class="primary_input ">
                  <input class="primary_input_field form-control {{ $errors->has('refund_file') ? ' is-invalid' : '' }}"
                    readonly="true" type="text"
                    placeholder="{{ isset($editData->upload_file) && @$editData->upload_file != '' ? getFilePath3(@$editData->upload_file) : trans('common.file') . '' }}"
