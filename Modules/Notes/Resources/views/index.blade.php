        ...
        <div class="white-box">
          <div class="row mb-20 align-items-center">
            ...
            <div class="col-lg-6 col-md-6 text-right">
              ...
              @if(!empty($showingAll))
              <a href="{{ route('notes.index') }}" class="primary-btn small tr-bg mr-10">@lang('common.my')
                @lang('Notes')</a>
              @else
              <a href="{{ route('notes.all') }}" class="primary-btn small tr-bg mr-10">@lang('common.view')
                @lang('common.all')</a>
              @endif
              @endif
                ...
                <table class="table" id="notes_table" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ optional($note->user)->full_name ?? '-' }}</td>
                      <td>
                        @if($note->noteable)
