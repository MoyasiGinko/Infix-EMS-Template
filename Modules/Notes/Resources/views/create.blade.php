    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            <div class="row">
                <div class="col-lg-6">
                    <div class="white-box">
                        <div class="main-title"><h3 class="mb-15">@lang('common.add') @lang('Notes')</h3></div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 mt-15">
                                    <div class="primary_input">
                                        ...
                                        <input type="text" class="primary_input_field" name="title" id="title" value="{{ old('title') }}" required>
                                ...
                                <div class="col-lg-6 mt-15">
                                    <div class="primary_input">
                                        ...
                                        <input type="number" class="primary_input_field" name="reference_id" id="reference_id" value="{{ old('reference_id') }}">
                                    </div>
                                </div>
                                <div class="col-lg-6 mt-15">
                                    <div class="primary_input">
                                ...
                                <div class="col-lg-6 mt-15">
                                    <div class="primary_input">
                                        ...
                                        <input type="number" class="primary_input_field" name="quantity" id="quantity" value="{{ old('quantity') }}">
                                    </div>
                                </div>
                                <div class="col-lg-6 mt-15">
                                    <div class="primary_input">
                                        <label class="primary_input_label" for="amount">@lang('common.amount')</label>
                                        <input type="number" step="0.01" class="primary_input_field" name="amount" id="amount" value="{{ old('amount') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-40">
