      ...
      <div class="col-lg-8">
        <div class="white-box">
          <div class="main-title d-flex justify-content-between align-items-center">
            ...
            <div>
              ...
              <a href="{{ route('notes.edit',$note) }}"
                class="primary-btn small fix-gr-bg mr-10">@lang('common.edit')</a>
              @endif
          ...
          <div class="row mt-10">
            ...
            <div class="col-lg-6 mb-10"><strong>@lang('common.amount'):</strong> {{ number_format($note->amount,2) }}
            </div>
            <div class="col-lg-6 mb-10"><strong>@lang('common.created_by'):</strong>
              {{ optional($note->user)->full_name ?? optional($note->user)->name }}</div>
            <div class="col-lg-12 mb-10"><strong>@lang('common.content'):</strong><br>{{ $note->content }}</div>
            <div class="col-lg-6 mb-10"><strong>@lang('common.date'):</strong>
              {{ $note->created_at->format('Y-m-d H:i') }}</div>
          </div>
        </div>
      </div>
    </div>
