...
<div class="fees-modal__body">
    <div class="fees-ledger__summary">
        <div class="fees-ledger__summary-card">
            ...
            <span class="fees-ledger__summary-value"><span>{{ $currencySymbol }}</span>{{ number_format($assignedAmount, 2) }}</span>
        </div>
        <div class="fees-ledger__summary-card">
            <span class="fees-ledger__summary-label">@lang('fees::feesModule.waiver')</span>
            <span class="fees-ledger__summary-value"><span>{{ $currencySymbol }}</span>{{ number_format($waiverAmount, 2) }}</span>
        </div>
        <div class="fees-ledger__summary-card">
            <span class="fees-ledger__summary-label">@lang('fees.fine')</span>
            <span class="fees-ledger__summary-value"><span>{{ $currencySymbol }}</span>{{ number_format($fineAmount, 2) }}</span>
        </div>
        <div class="fees-ledger__summary-card">
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('fees::feesModule.payment_method')">
                                <div class="fees-modal__cell-stack">
                                    <span class="fees-modal__tag"><i class="ti-credit-card"></i> {{ $feesTranscation->payment_method }}</span>
                                </div>
                            </td>
