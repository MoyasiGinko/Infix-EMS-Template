...
<section class="admin-visitor-area up_st_admin_visitor">
  <div class="max_1200 text-right">
    <a href="{{ route('fees.single-payment-view', ['id' => $id, 'type' => 'print']) }}"
                      ...
                      <tr>
                        <td>
                          <div class="addressleft_text">
                            ...
                            <p><span>@lang('student.class_section')</span> <span>:
                                {{@$invoiceInfo->recordDetail->class->class_name}}
                                ({{@$invoiceInfo->recordDetail->section->section_name}})</span> </p>
                            <p><span>@lang('student.roll_no')</span> <span>:
                                {{@$invoiceInfo->studentInfo->roll_no}}</span> </p>
                        ...
                        <td>
                          ...
                          <div class="addressright_text">
                            ...
                            @if($paidAmount > 0 && $lastPaidAt)
                              <p><span>{{ __('fees.paid_date') !== 'fees.paid_date' ? __('fees.paid_date') : 'Payment Date' }}</span> <span>: {{ dateConvert($lastPaidAt) }}</span></p>
                            @endif
                          </div>
                        </td>
                      </tr>
