...
<section class="admin-visitor-area up_st_admin_visitor student-details">
  <div class="container-fluid p-0">
    @php
    $record_id = !empty($invoiceInfo->recordDetail) ? $invoiceInfo->recordDetail->id :
    $invoiceInfo->studentInfo->lastRecord->id;
    @endphp
    @if (isset($role) && $role == 'admin')
        ...
        <div class="student-meta-box">
          ...
          <div class="white-box radius-t-y-0">
            ...
            <div class="row chequeBank d-none">
              <div class="col-lg-12">
                <div class="primary_input">
                  <label class="primary_input_label" for="">{{ trans('common.file') }}</label>
                ...
                <div class="col-lg-12">
                  <div class="primary_input">
                    ...
                    <input class="primary_input_field form-control card-expiry-month" type="text"
                      name="card-expiry-month" autocomplete="off" value="{{ old('card-expiry-month') }}">
                ...
                <table class="table school-table-style p-0" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="primary_input">
                          <input class="primary_input_field border-0 form-control showTotalValue" type="text"
                      ...
                      <td>
                        <input class="primary_input_field form-control addFeesPaidAmount" type="number" step="0.01"
                          min="0" name="paid_amount[]" autocomplete="off">
                      </td>
                      <td>
                        @if (isset($role) && $role == 'admin')
                        <div class="primary_input">
                          <input class="primary_input_field form-control addFeesWeaver" type="number" step="0.01"
                            min="0" name="weaver[]" autocomplete="off"
                        ...
                        <input class="primary_input_field border-0 form-control"
                          value="{{ isset($invoiceDetail) ? $invoiceDetail->weaver : 0 }}" autocomplete="off" readonly>
                        @endif
                      </td>
                      <td>
                        @if (isset($role) && $role == 'admin')
                        <input class="primary_input_field form-control addFeesFine" type="number" step="0.01" min="0"
                          name="fine[]" autocomplete="off" value="0">
                        @else
                        <input class="primary_input_field border-0 form-control"
                          value="{{ isset($invoiceDetail) ? $invoiceDetail->fine : 0 }}" autocomplete="off" readonly>
                        @endif
                      </td>
                      <td>
                        <button class="primary-btn icon-only fix-gr-bg" data-toggle="modal" data-tooltip="tooltip"
                          data-target="#addNotesModal{{ $invoiceDetail->fees_type }}" type="button" data-placement="top"
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="primary_input">
                                ...
                                <input class="primary_input_field form-control has-content" type="text" name="note[]"
                                  autocomplete="off">
                              </div>
                              <br />
...
<script type="application/json" id="invoicePositionsDataAddPayment">
{
  {
...
<script>
// Initialize invoice element positions safely (avoid raw Blade JS injection)
(function() {
  var el = document.getElementById('invoicePositionsDataAddPayment');
  try {
