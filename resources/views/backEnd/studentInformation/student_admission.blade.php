          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="tab-content modern-tab-content">
                <div role="tabpanel" class="tab-pane fade show active" id="student_guardian_info">
                  <div id="personal_info" class="admission-section modern-section-card">
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="col-lg-6 mt-4">
                          <div class="primary_input " id="sectionStudentDiv">
                            <label class="primary_input_label" for="">@lang('common.section') <span class="text-danger">
                                *</span> </label>
                            <select
                          ...
                          <div class="primary_input mb-15">
                            ...
                            <div class="primary_datepicker_input">
                              <div class="no-gutters input-right-icon">
                                ...
                                <button class="btn-date" style="top: 55% !important;" data-id="#admission_date"
                                  type="button">
                        ...
                        <div class="col-lg-6 mt-4">
                          <div class="primary_input ">
                            ...
                            <input oninput="numberCheck(this)"
                              ...
                              type="text" id="roll_number" name="roll_number" value="{{ old('roll_number') }}">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6 mt-4">
                          <div class="primary_input ">
                            ...
                            <select class="primary_select form-control{{ $errors->has('gender') ? ' is-invalid' : '' }}"
                              name="gender">
                          ...
                          <div class="primary_input">
                            ...
                            <div class="primary_datepicker_input">
                              <div class="no-gutters input-right-icon">
                                ...
                                <button class="btn-date" style="top: 55% !important;" data-id="#date_of_birth"
                                  type="button">
                        ...
                        <div class="col-lg-6 mt-4">
                          <div class="primary_input ">
                            ...
                            <input
                              ...
                              type="text" name="caste" value="{{ old('caste') }}">
                          ...
                          <div class="primary_input">
                            <div class="primary_file_uploader">
                              ...
                              <button class="" type="button">
                                ...
                                <input type="file" class="d-none" name="photo" id="addStudentImage">
                              </button>
                            </div>
                          </div>
                          @if ($errors->has('photo'))
                        ...
                        <div class="col-md-12 mt-15">
                          <img class="d-none previewImageSize" src="" alt="" id="studentImageShow" height="100%"
                            width="100%">
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="col-lg-6 mt-4">
                          <div class="primary_input ">
                            ...
                            <input oninput="emailCheck(this)"
                              ...
                              id="email_address" type="text" name="email_address" value="{{ old('email_address') }}">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6 mt-4 ">
                              <div class="primary_input" style="margin-top:53px !important">
                                <select
                                  ...
                                  <option value="{{ $city->id }}" {{ old('lead_city') == $city->id ? 'selected' : '' }}>
                                    {{ $city->city_name }}
                                  </option>
                                  @endforeach
                                </select>
                            ...
                            <div class="col-lg-6 mt-4">
                              <div class="primary_input ">
                                ...
                                <textarea
                                  class="primary_input_field form-control{{ $errors->has('current_address') ? ' is-invalid' : '' }}"
              ...
              <div id="parents_and_guardian_info" class="admission-section modern-section-card">
                <div class="row pt-4 row-gap-24">
                  <div class="col-lg-12">
                    <div class="form-section">
                      <div class="row">
                                    ...
                                    <div class="row">
                                      <div class="col-lg-12">
                                        <div class="d-flex radio-btn-flex">
                                          <div class="mr-30">
                                            <input type="radio" name="subject_type" id="siblingParentRadio"
                                              value="sibling" class="common-radio relationButton addParent" checked>
                                            <label for="siblingParentRadio">@lang('student.From Sibling')</label>
                                          </div>

                                          <div class="mr-30">
                                            <input type="radio" name="subject_type" id="staffParentRadio" value="staff"
                                        ...
                                        <div class="row mt-15">
                                          <div class="col-lg-12" id="sibling_class_div">
                                            ...
                                            <select class="primary_select" name="sibling_class"
                                              ...
                                              <option data-display="@lang('student.class') *" value="">
                                                @lang('student.class')
                                                *
                                              </option>
                                              @foreach ($classes as $class)
                                        ...
                                        <div class="row mt-15">
                                          <div class="col-lg-12" id="sibling_name_div">
                                            <label for="primary_input_label">@lang('student.sibling')
                                              <span class="text-danger">
                                                *</span></label>
                                            <select class="primary_select" name="select_sibling_name"
                                              id="select_sibling_name">
                                              <option data-display="@lang('student.sibling') *" value="">
                                      ...
                                      <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                          <div class="col-lg-12" id="staff_class_div">
                                            <select class="primary_select" id="select_staff_parent">
                                              <option data-display="@lang('hr.select_staff') *" value="">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6 mt-4">
                              <div class="primary_input ">
                                ...
                                <input
                                  ...
                                  type="text" name="fathers_occupation" id="fathers_occupation"
                            ...
                            <div class="col-lg-6 mt-4">
                              <div class="primary_input">
                                ...
                                <div class="primary_file_uploader">
                                  <input class="primary_input_field" type="text" id="placeholderFathersName"
                                    placeholder="@lang('student.photo')" readonly="">
                                  <button class="" type="button">
                                    <label class="primary-btn small fix-gr-bg"
                                      for="addFatherImage">{{ __('common.browse') }}</label>
                                    <input type="file" class="d-none" name="fathers_photo" id="addFatherImage">
                                  </button>
                                </div>
                            ...
                            @endif
                            <div class="col-md-12 mt-15">
                              <img class="d-none previewImageSize" src="" alt="" id="fatherImageShow" height="100%"
                                width="100%">
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row mt-4">
                        ...
                        <div class="col-lg-6 mt-4">
                          <div class="primary_input ">
                            ...
                            <input
                              ...
                              type="text" name="mothers_occupation" id="mothers_occupation"
                        ...
                        <div class="col-lg-6 mt-4">
                          <div class="primary_input mb-15">
                            ...
                            <div class="primary_file_uploader">
                              <input class="primary_input_field" type="text" id="placeholderMothersName"
                                placeholder="@lang('student.photo')" readonly="">
                              <button class="" type="button">
                                <label class="primary-btn small fix-gr-bg"
                                  for="addMotherImage">{{ __('common.browse') }}</label>
                                <input type="file" class="d-none" name="mothers_photo" id="addMotherImage">
                              </button>
                            </div>
                        ...
                        @endif
                        <div class="col-md-12 mt-15">
                          <img class="d-none previewImageSize" src="" alt="" id="motherImageShow" height="100%"
                            width="100%">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6 mt-4">
                          <div class="primary_input ">
                            ...
                            <input class="primary_input_field read-only-input" type="text" placeholder="Relation"
                        ...
                        <div class="col-lg-6 mt-4">
                          <div class="primary_input">
                            ...
                            <div class="primary_file_uploader">
                              <input class="primary_input_field" type="text" id="placeholderGuardiansName"
                                placeholder="@lang('student.photo')" readonly="">
                              <button class="" type="button">
                                <label class="primary-btn small fix-gr-bg"
                                  for="addGuardianImage">{{ __('common.browse') }}</label>
                                <input type="file" class="d-none" name="guardians_photo" id="addGuardianImage">
                              </button>
                            </div>
                        ...
                        @endif
                        <div class="col-md-12 mt-15">
                          <img class="d-none previewImageSize" src="" alt="" id="guardianImageShow" height="100%"
                            width="100%">
                        </div>
                        ...
                        <div class="col-lg-6 mt-4">
                          <div class="primary_input ">
                            ...
                            <input
                              ...
                              type="text" name="guardians_occupation" id="guardians_occupation"
                        ...
                        <div class="col-lg-12 mt-4">
                          <div class="primary_input ">
                            ...
                            <textarea
                              class="primary_input_field form-control{{ $errors->has('guardians_address') ? ' is-invalid' : '' }}"
            ...
            <div role="tabpanel" class="tab-pane fade" id="document_info">
              <div class="admission-section modern-section-card">
                <div class="row pt-4 row-gap-24">
                  <div class="col-lg-6">
                    <div class="form-section">
                      <div class="row">
                        ...
                        <div class="col-lg-6 mt-4">
                          <div class="primary_input ">
                            ...
                            <input
                              ...
                              type="text" name="local_id_number" value="{{ old('local_id_number') }}">
                        ...
                        <div class="col-lg-12 mt-4">
                          <div class="primary_input ">
                            ...
                            <textarea
                              class="primary_input_field form-control{{ $errors->has('additional_notes') ? ' is-invalid' : '' }}"
                        ...
                        <div class="col-lg-6 mt-4">
                          <div class="primary_input ">
                            ...
                            <input
                              ...
                              type="text" name="bank_account_number" value="{{ old('bank_account_number') }}">
                        ...
                        <div class="col-lg-6 mt-4">
                          <div class="primary_input">
                            ...
                            <input
                              ...
                              type="text" name="ifsc_code" value="{{ old('ifsc_code') }}">
                            ...
                            <div class="col-lg-12">
                              <div class="primary_input ">
                                ...
                                <input
                                  ...
                                  type="text" name="document_title_1" value="{{ old('document_title_1') }}">
                              ...
                              <div class="primary_input">
                                <div class="primary_file_uploader">
                                  <input class="primary_input_field" type="text" name="document_title_1"
                                    ...
                                    placeholder="01  @if (is_required('document_file_1') == true) * @endif" readonly="">
                                  <button class="" type="button">
                                    <label class="primary-btn small fix-gr-bg"
                            ...
                            <div class="col-lg-12">
                              <div class="primary_input ">
                                ...
                                <input
                                  ...
                                  type="text" name="document_title_2" value="{{ old('document_title_2') }}">
                              ...
                              <div class="primary_input">
                                <div class="primary_file_uploader">
                                  <input class="primary_input_field" type="text" id="placeholderFileTwoName"
                                    placeholder="01  @if (is_required('document_file_2') == true) * @endif" readonly="">
                                  <button class="" type="button">
                                    <label class="primary-btn small fix-gr-bg"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                          <div class="row">
                            ...
                            <div class="col-lg-12">
                              <div class="primary_input ">
                                ...
                                <input
                                  ...
                                  type="text" name="document_title_3" value="{{ old('document_title_3') }}">
                            ...
                            <div class="col-lg-12 mt-2 mb-3 mb-lg-0">
                              <div class="primary_input">
                                <div class="primary_file_uploader">
                                  <input class="primary_input_field" type="text" id="placeholderFileThreeName"
                                    placeholder="01  @if (is_required('document_file_3') == true) * @endif" readonly="">
                                  <button class="" type="button">
                                    <label class="primary-btn small fix-gr-bg"
                            ...
                            <div class="col-lg-12">
                              <div class="primary_input ">
                                ...
                                <input
                                  ...
                                  type="text" name="document_title_4" value="{{ old('document_title_4') }}">
                              ...
                              <div class="primary_input">
                                <div class="primary_file_uploader">
                                  <input class="primary_input_field" type="text" id="placeholderFileFourName"
                                    placeholder="01  @if (is_required('document_file_4') == true) * @endif" readonly="">
                                  <button class="" type="button">
                                    <label class="primary-btn small fix-gr-bg"
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-12">
                          <div class="primary_input ">
                            ...
                            <textarea
                              class="primary_input_field form-control{{ $errors->has('previous_school_details') ? ' is-invalid' : '' }}"
                              cols="0" rows="5"
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="row mb-15 mt-30">
                            ...
                            <div class="col-lg-6">
                              <div class="primary_input ">
                                <label for="primary_input_label">@lang('student.route_list')
                                  <span>
                            ...
                            <div class="col-lg-6">
                              <div class="primary_input " id="select_vehicle_div">
                                <label for="primary_input_label">@lang('student.vehicle_number')
                                  <span>
                  ...
                  <div class="col-lg-6">
                    <div class="form-section">
                      ...
                      <div class="row mb-15 mt-30">
                        ...
                        <div class="col-lg-6">
                          <div class="primary_input ">
                            <label for="primary_input_label">@lang('dormitory.dormitory')
                              <span>
                        ...
                        <div class="col-lg-6">
                          <div class="primary_input " id="roomNumberDiv">
                            <label for="primary_input_label">@lang('academics.room_number')
                              <span>
                            ...
                            <select
                              ...
                              <option data-display="@lang('academics.room_number')" value="">
